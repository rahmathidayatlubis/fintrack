...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-primary-950 to-slate-900" style="background: linear-gradient(135deg, #0F172A 0%, #1E3A8A 50%, #0F172A 100%);">
...
<div class="max-w-md mx-auto min-h-screen flex flex-col">
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 pt-16 pb-8">
        <!-- Logo -->
        <div class="w-20 h-20 rounded-3xl bg-blue-500/20 backdrop-blur border border-blue-400/30 flex items-center justify-center mb-6 shadow-2xl">
        ...
        <div class="w-full relative mb-8">
            <div class="absolute inset-0 flex items-center justify-center opacity-20">
                <div class="w-48 h-28 rounded-2xl bg-gradient-to-r from-blue-400 to-blue-600 rotate-12 transform"></div>
                <div class="w-48 h-28 rounded-2xl bg-gradient-to-r from-indigo-400 to-purple-600 -rotate-6 transform ml-4 -mt-4"></div>
            </div>
        </div>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" @click="showPass = !showPass"
                        ...
                        <svg x-show="showPass" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="display:none">
...
<script>tailwind.config = { theme: { extend: { fontFamily: { sans: ['Plus Jakarta Sans', 'sans-serif'] }, borderRadius: { '4xl': '2rem' } } } }</script>
</body>
</html>
